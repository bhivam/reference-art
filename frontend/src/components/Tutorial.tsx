...
const Tutorial = forwardRef<HTMLDialogElement>((props, ref) => (
  <dialog ref={ref} className="tutorial-modal rounded-xl max-w-4xl  p-4 absolute m-auto left-0 right-0 bottom-0 top-0">
